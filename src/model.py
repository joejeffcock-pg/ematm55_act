...
if __name__ == "__main__":
    ...
    for split in [1,2,3]:
        # dataset
        X_train = np.load("/home/jeff/.mpose/openpose/{}/X_train.npy".format(split))
        y_train = np.load("/home/jeff/.mpose/openpose/{}/y_train.npy".format(split))
        X_test = np.load("/home/jeff/.mpose/openpose/{}/X_test.npy".format(split))
